Balabolka (aplicativo de console), versão 1.37
...
-d <nome_do_arquivo>
   Use o dicionário para a pronúncia correcta (arquivo com nextensão *.REX ou *.DIC). A linha de comando pode conter várias opções [-d].
