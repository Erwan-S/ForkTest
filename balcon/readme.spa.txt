Balabolka (aplicación de consola), versión 1.37
...
Speech API: 4.0/5.0 y superiores
...
-d <nombre_de_archivo>
   Usa un diccionario para la corrección de la pronunciación (*.REX o *.DIC). La línea de comandos puede contener varias opciones [-d].
